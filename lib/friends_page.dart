...
class _FriendsPageState extends State<FriendsPage>
  ...
  Future<void> _acceptRequest(String requestId) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('已接受好友申請'), backgroundColor: Colors.green),
    );
  }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text('還沒有好友', style: TextStyle(fontSize: 18, color: Colors.grey.shade500)),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('沒有待處理的申請', style: TextStyle(fontSize: 18, color: Colors.grey.shade500)),
          ],
        ),
      );
    }
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            title: Text(request['fromName'] ?? '未知用戶'),
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('搜尋好友', style: TextStyle(fontSize: 18, color: Colors.grey.shade500)),
                  const SizedBox(height: 8),
                  Text('輸入對方的用戶名稱或手機號碼',
